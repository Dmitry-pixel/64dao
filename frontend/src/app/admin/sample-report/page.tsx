...
// Слотов четыре. Методы 1-2 продаются одним тарифом и показываются одним блоком
...
const SLOTS = [
  ...
  {
    method: '4',
    title: 'Метод 4 · Алмазное колесо',
    hint: 'Кнопка «Скачать пример отчёта» в блоке «Алмазное колесо»',
    viewUrl: '/api/sample-report/view?method=4',
  },
  {
    method: 'methodology',

...
/** Продукты: m12 — Методы 1 и 2 по общей цене, m3 — Методы 3 и 4 по своей общей. */
type Product = 'm12' | 'm3'
...
const PRODUCT_TABS: { code: Product; label: string; hint: string }[] = [
  ...
  { code: 'm3', label: 'Метод 3 + Метод 4', hint: 'Одна цена на две диагностики: матрица силы и алмазное колесо.' },
]

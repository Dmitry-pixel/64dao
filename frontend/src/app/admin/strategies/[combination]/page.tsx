...
const HEXAGRAM_DATA = [
  ...
  { n: 15, combo: 'AABBBB', name: 'Смирение',            stage: 'Обновление' },
  ...
  { n: 19, combo: 'BBAAAA', name: 'Подход',              stage: 'Расцвет'    },
  ...
  { n: 33, combo: 'BABBAA', name: 'Благоразумие',        stage: 'Упадок'     },
  { n: 34, combo: 'AAAABB', name: 'Сила',                stage: 'Расцвет'    },
  { n: 35, combo: 'BBBABA', name: 'Благоприятный',       stage: 'Расцвет'    },
  { n: 36, combo: 'ABABAA', name: 'Неблагоприятный',     stage: 'Упадок'     },
  { n: 37, combo: 'ABABBB', name: 'Гармония',            stage: 'Зарождение' },
  ...
  { n: 57, combo: 'BAABAA', name: 'Интуиция',            stage: 'Обновление' },
  { n: 58, combo: 'AABAAB', name: 'Бодрость',            stage: 'Расцвет'    },
  { n: 59, combo: 'BBABBB', name: 'Установление связей', stage: 'Обновление' },

    ...
    >
      ...
      >
        <div style={{ minWidth: 0 }}>
          ...
          >
            64 ДАО — это стратегический диагностический инструмент, основанный на метафизике «И Цзин»,
            предназначенный для оценки текущего этапа развития компании. Он позволяет принимать
            обоснованные управленческие решения и служит основой для стратегических совещаний, помогая
            предприятиям определить свой текущий этап и выбрать наиболее подходящие действия.
          </p>

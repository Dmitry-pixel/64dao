 ...
 *
 * Ячейку задаёт сумма отраслевых весов линий-Ян, а НЕ координата. Координата
 * ставит точку внутри уже выбранной ячейки. Эти две величины могут
 * расходиться — направление с координатой привлекательности 2,25 может стоять
 * в нижнем ряду, если его сильные линии для отрасли лёгкие. Рисовать по одной
 * координате значило бы спорить с подписью зоны.
 *
